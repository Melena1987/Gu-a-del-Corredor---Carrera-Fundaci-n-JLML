...
const description5k = 'Salida 11:00h desde Salida/Meta (Estación de Madrid) sentido ascendente, Plaza de la Constitución (carril junto a Jardines Santa Margarita), calle Julio Burell, Plaza Colón,calle Viriato, calle Yanguas Messías, calle Cánovas del Castillo, calle Yanguas Jiménez, calle General Echagüe, calle Huarte de San Juan, calle Iglesia, calle Carnecería, Plaza del Ayuntamiento (por el carril junto a escaleras del parking), Avenida de Andalucía sentido hacia el minero, vuelta en la rotonda de Plaza Aníbal e Himilce, Avenida Andalucía sentido Ayuntamiento, Plaza del Ayuntamiento (carril junto a Palacio Consistorial), Plaza Ramón y Cajal, Pasaje del Comercio, Corredera de San Marcos baja, 8 puertas, Corredera San Marcos alta, Plaza de la Constitución (carril junto a Farmacia), subida por el carril de sentido descendente del Paseo de Linarejos, Glorieta de América, Paseo de la Ermita hasta el Club 79, cambio de sentido Paseo de la Ermita hasta Glorieta de América, Bajada por el sentido ascendente del Paseo de Linarejos hasta el cambio de sentido tras la entrada al Parking, entrada por la fuente de la Paloma en la zona central peatonal del Paseo de Linarejos, Llegada a META';

const mapData = [
  {
    title: 'Recorrido Escolar (800m)',
    description: 'Un circuito para los más pequeños.',
    detailedDescription: 'Salida desde Salida/Meta (Estación de Madrid), subida por el carril de sentido descendente hacia la Glorieta de América, cambio de sentido para coger la bajada por el sentido ascendente del Paseo de Linarejos hasta la llegada de Línea de META',
  ...
  },
  {
    ...
    detailedDescription: 'Salida desde Salida/Meta (Estación de Madrid) sentido ascendente, Plaza de la Constitución (carril junto a Jardines Santa Margarita), calle Julio Burell, Plaza Colón,calle Viriato, Isaac Peral, 8 puertas, Corredera San Marcos Alta, Plaza de la Constitución (carril junto a Farmacia), subida por el carril del Paseo de Linarejos sentido descendente, Glorieta de América, bajada por el carril del Paseo de Linarejos sentido ascendente, LLEGADA a meta.',
